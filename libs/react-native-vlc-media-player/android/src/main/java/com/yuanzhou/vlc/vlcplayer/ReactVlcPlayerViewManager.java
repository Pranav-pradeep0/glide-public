...
public class ReactVlcPlayerViewManager extends SimpleViewManager<ReactVlcPlayerView> {
    ...
    public void setVolume(final ReactVlcPlayerView videoView, final float volume) {
        videoView.setVolumeModifier(Math.round(volume));
    }
    ...
    public void setResizeMode(final ReactVlcPlayerView videoView, final String resizeMode) {
    ...
    public void setTitle(final ReactVlcPlayerView videoView, final String title) {
        videoView.setVideoTitle(title);
    }

    @ReactProp(name = PROP_ARTIST)
    public void setArtist(final ReactVlcPlayerView videoView, final String artist) {
        videoView.setVideoArtist(artist);
    }

    @ReactProp(name = PROP_AUDIO_EQUALIZER)
    public void setAudioEqualizer(final ReactVlcPlayerView videoView, final ReadableArray bands) {
        videoView.setAudioEqualizer(bands);
    }
    ...
    public void pausePlayer(final ReactVlcPlayerView videoView) {
